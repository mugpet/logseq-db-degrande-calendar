...
Degrande Calendar adds a focused week and month bar to Logseq DB journals. It sits in Logseq's pagebar area, lets you switch between a compact week strip and a month grid, and jump straight to a journal day without taking over the rest of the app UI.
...
- Week and month views for journals with a configurable first day of week.
- Previous week, next week, and today controls.
- One-click journal navigation for each day in the visible week.
- Animated week and month browsing inside the calendar bar.
...
- The calendar bar appears for journal pages and journals view contexts.
